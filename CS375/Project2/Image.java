...
// Contents: This class is for graphic image rendering when saving or adjusting.
...
public class Image extends JPanel
{
        ...
        public void paintComponent (Graphics g)
        {
                ...
                BufferedImage bufferedimage = flippedBufferedImage ();
                int width = getWidth();
                int height = getHeight();
                g2.setClip (new RoundRectangle2D.Double(0.1*width, 0.1*height, 0.8*width, 0.8*height, 50, 50));
